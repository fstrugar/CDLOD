...
HRESULT WINAPI DXUTCreateDevice( bool bWindowed, int nSuggestedWidth, int nSuggestedHeight )
{
    ...
    matchOptions.eDepthFormat = DXUTMT_CLOSEST_TO_INPUT; //DXUTMT_IGNORE_INPUT;
    matchOptions.eStencilFormat = DXUTMT_CLOSEST_TO_INPUT; //DXUTMT_IGNORE_INPUT;
    ...
    deviceSettings.d3d9.pp.AutoDepthStencilFormat = D3DFMT_D24S8;
    ...
    switch( hr )
    {
        ...
        case DXUTERR_NOCOMPATIBLEDEVICES:
            ...
            if( GetSystemMetrics( 0x1000 ) != 0 ) // SM_REMOTESESSION
                ...
                StringCchCopy( strBuffer, ARRAYSIZE(strBuffer), L"Could not find any compatible Direct3D devices - graphics card or driver not supported." );
            break;
